...
A1 and A2 are separate selectable paths. Existing A1–A2 local/cloud state is migrated lazily into both paths and then scoped to the appropriate level.
