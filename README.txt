...
SYNC BACKEND 5.1
This build requires the existing DeutschPath 5.1 Merge/Event Sync Code.gs backend. No backend change is required when upgrading from 5.1.3 to 5.1.6.

5.1.6 full review and consistency fixes:
...
- PWA cache is versioned as 5.1.6, course assets use 5.1.6 cache-busting, and offline asset matching ignores the query string so all four level packs remain available offline.
