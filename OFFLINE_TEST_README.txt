...
3) This local file copy does not register the PWA service worker; the Backup page will show "Local test mode".
4) Local progress is stored in this browser's local storage for the file copy.
